...
!      called by hypgeo, cf. line 4733.
!     -replaced tabs by 2 whitespaces
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
module nr_hypgeometric
  use kinds, only: default !NODEP!
  use nrtype, only: spc !NODEP!
  use nr, only: hypgeo !NODEP!
  implicit none
