...
module Id =
  struct
    ...
    let as_block_data_to_channel m oc tag i n_ch n_beam =
      fprintf oc "      data bdmap%s(%d,%d,%d) /0/\n" tag i n_ch n_beam;
      fprintf oc "      data bdalf%s(%d,%d,%d) /1D0/\n" tag i n_ch n_beam;
      fprintf oc "      data bdxi%s(%d,%d,%d) /0D0/\n" tag i n_ch n_beam;
      fprintf oc "      data bdeta%s(%d,%d,%d) /0D0/\n" tag i n_ch n_beam;
      fprintf oc "      data bda%s(%d,%d,%d) /1D0/\n" tag i n_ch n_beam;
      fprintf oc "      data bdb%s(%d,%d,%d) /1D0/\n" tag i n_ch n_beam
...
module Resonance =
  struct
    ...
    let as_block_data_to_channel m oc tag i n_ch n_beam =
      fprintf oc "      data bdmap%s(%d,%d,%d) /2/\n"
        tag i n_ch n_beam;
      fprintf oc "      data bdalf%s(%d,%d,%d) /0D0/\n"
        tag i n_ch n_beam;
      fprintf oc "      data bdxi%s(%d,%d,%d) /%s/\n"
        tag i n_ch n_beam (Float.Double.to_string m.xi);
      fprintf oc "      data bdeta%s(%d,%d,%d) /%s/\n"
