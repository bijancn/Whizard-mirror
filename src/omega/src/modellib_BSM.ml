...
let rcs_file = RCS.parse "Modellib_BSM" ["BSM Models"]
    { RCS.revision = "$Revision: 5351 $";
      RCS.date = "$Date: 2014-02-22 12:50:48 +0100 (Sa, 22 Feb 2014) $";
      RCS.author = "$Author: msekulla $";
      RCS.source
        = "$URL: http://whizard.hepforge.org/svn/trunk/src/omega/src/modellib_BSM.ml $" }
...
(* 4-fermion contact terms emerging from operator rewriting: *)
    ...
    let vertices4 =
      quartic_gauge @ gauge_higgs4 @ higgs4 @ rsigma4
