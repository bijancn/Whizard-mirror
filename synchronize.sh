...
SRC_FILES="src/Makefile.am src/feynmf/Makefile.am src/hepmc/Makefile.am src/hepmc/HepMCWrap_dummy.f90 src/lhapdf/Makefile.am src/lhapdf5/Makefile.am src/pdf_builtin/Makefile.am src/pdf_builtin/pdf_builtin.f90 pythia/Makefile.am src/stdhep/Makefile.am src/noweb-frame/Makefile.am src/noweb-frame/whizard-prelude.nw src/noweb-frame/whizard-postlude.nw src/basics/Makefile.am src/utilities/Makefile.am src/utilities/utilities.nw src/testing/Makefile.am src/testing/testing.nw src/system/Makefile.am src/system/system.nw src/combinatorics/Makefile.am src/combinatorics/combinatorics.nw src/parsing/Makefile.am src/parsing/parsing.nw src/physics/Makefile.am src/physics/physics.nw src/whizard-core/Makefile.am src/whizard-core/whizard.nw"
...
SRC_MISC_FILES="src/basics/constants.f90 src/basics/iso_fortran_env_stub.f90 src/basics/kinds.f90.in src/basics/io_units.f90 src/system/system_dependencies.f90.in"
