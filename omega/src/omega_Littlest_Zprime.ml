(* $Id: omega_Littlest_Zprime.ml 6465 2015-01-10 15:22:31Z jr_reuter $
...
let rcs_file = RCS.parse "omega_Zprime" ["Standard Model with Additional Vectors"]
    { RCS.revision = "$Revision: 6465 $";
      ...
      RCS.source
        = "$URL: svn+ssh://cweiss@svn.hepforge.org/hepforge/svn/whizard/trunk/omega/src/omega_Littlest_Zprime.ml $" }
