% $Id: omega.tex 3274 2011-05-26 08:29:57Z jr_reuter $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\author{%
  ...
  \hfil\\
  Christian Speckner${}^{d,}$\thanks{\texttt{christian.speckner@physik.uni-freiburg.de}}\\
  \hfil\\
...
\newpage
\begin{quote}
  Copyright \textcopyright~1999-2010 by
  \begin{itemize}
